...
#pragma endregion
	private: System::Void NumberButton(System::Object^ sender, System::EventArgs^ e) {
	...
	bool checkDisplayFraction() // Проверка
	{
...
private: System::Void button15_Click(System::Object^ sender, System::EventArgs^ e) { // Кнопка точки
...
private: System::Void FocusNum(System::Object^ sender, System::EventArgs^ e) {
	DisplayCheckFractrion = 1;
}
private: System::Void FocusDen(System::Object^ sender, System::EventArgs^ e) {
	DisplayCheckFractrion = 2;
}
private: System::Void FocusInt(System::Object^ sender, System::EventArgs^ e) {
	DisplayCheckFractrion = 3;
}
private: System::Void NumberFraction(System::Object^ sender, System::EventArgs^ e) {
...
private: System::Void ActionFraction(System::Object^ sender, System::EventArgs^ e) {
...
private: System::Void button37_Click(System::Object^ sender, System::EventArgs^ e) { // Кнопка = обыкновенная дробь
	...
	if (TipeActionFraction == "+")
	{
		...
		if (FirstDenominator != SecondDemoninator)
		{
